...
export default function LiveVideoPage() {
  ...
  const handleShare = async () => {
    try {
      if (navigator.share) {
        await navigator.share({ title: 'Nefzawa TV - Live', url: window.location.href });
      } else {
  ...
  return (
    <div className="bg-[#050505] min-h-screen pb-32 font-arabic text-white" dir="rtl">
      <Helmet>
        ...
        <meta name="description" content="شاهدوا البث المباشر لقناة نفزاوة TV. تغطية حية للأخبار والفعاليات في الجنوب التونسي وبث مباشر للبرامج الميدانية." />
      </Helmet>
            ...
            <div className="bg-zinc-900/90 backdrop-blur-2xl border border-white/10 rounded-[3rem] overflow-hidden shadow-2xl relative">
              ...
              <div className="p-6 border-b border-white/5 flex justify-between items-center bg-black/20">
                ...
                <div className="flex items-center gap-2 px-3 py-1 bg-red-600 rounded-full animate-pulse shadow-lg shadow-red-600/20">
                  ...
                  <span className="text-[10px] font-bold uppercase font-latin">Live</span>
                </div>
              </div>
              ...
              <div className="p-8 text-center md:text-right border-t border-white/5">
                 <p className="text-zinc-400 text-sm mb-0">في حال عدم ظهور البث، يرجى تحديث الصفحة أو تعطيل مانع الإعلانات</p>
              </div>
            </div>
...
تابعوا إذاعة نفزاوة FM مباشرة عبر هذا البثّ الحي، وابقوا على اطلاع دائم بأحدث البرامج والمحتوى الإعلامي المحلي والجهوي في أي وقت ومن أي مكان.                </p>
          ...
          <aside className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-[#E00A0A] rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-xl font-bold mb-4 relative z-10 text-right">شارك البث</h3>
              <button onClick={handleShare} className="w-full py-4 bg-black/30 backdrop-blur-md border border-white/20 rounded-2xl font-black flex items-center justify-center gap-3 hover:bg-black transition-all relative z-10 text-white">
