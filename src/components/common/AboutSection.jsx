      ...
      <div className="container mx-auto px-4 max-w-5xl relative z-10">
        ...
        <div className="text-center mb-16">
          <p className="text-xl md:text-xl text-slate-600 leading-relaxed max-w-4xl mx-auto font-latin font-medium">
            Founded in 2012, <span className="font-bold text-slate-900">Nefzawa</span> is dedicated to combating media marginalization in rural areas. 
            It defines itself as a hub for the development of associative media and a nursery for 
            the empowerment of youth in Tunisia, specifically in the southern regions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24" dir="rtl">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-3xl font-black text-slate-900 font-arabic mb-4">رؤيتنا</h3>
            <p className="text-lg text-slate-600 font-arabic leading-relaxed max-w-sm">
              تطوير وتعزيز صحافة الحلول ، وتغيير الصور النمطية السائدة في منطقة قبلي وتسليط الضوء على قصص نجاح مواطني قبلي
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-3xl font-black text-slate-900 font-arabic mb-4">شركاؤنا</h3>
            <p className="text-lg text-slate-600 font-arabic leading-relaxed max-w-sm">
              جمعيات وإعلاميين وصحفيين من مختلف ولايات الجنوب التونسي (قابس ، مدنين ، تطاوين ، قفصة. ، قبلي وتوزر)
            </p>
          </div>
