...
const imagesFolder = import.meta.glob('/src/assets/images/nefzawa-images/carousel-images/page-history-radio/*.webp', { eager: true });
...
export default function RadioHistory() {
  ...
  return (
    <div className="bg-[#fdfdfd] min-h-screen pb-32 font-arabic" >
      {/* Header  */}
      <HeaderSection title="تاريخ الإذاعة" subtitle="Découvrez l’évolution de la radio Nefzawa au fil du temps"  />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center my-32">
             <p className="text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed italic font-latin" >
               Découvrez l’histoire de la radio Nefzaoua et les différentes étapes de son évolution au fil des années, ainsi que les moments clés de son parcours. Nous vous invitons à explorer cet espace et à parcourir ses différentes étapes afin de découvrir son histoire dans son ensemble.
             </p>
          </div>
