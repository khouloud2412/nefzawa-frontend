...
const imagesFolder = import.meta.glob('/src/assets/images/nefzawa-images/carousel-images/page-mouwafak-aalami/*.webp', { eager: true });

export default function MouwafakAalami() {
  ...
  .map(([, img]) => ({ 
    src: img.default || img,
    alt: "mouwafak-aalami Slide"
  }));

  return (
    <div className="bg-[#fdfdfd] min-h-screen pb-32 font-arabic" >
      {/* Header  */}
      <HeaderSection title="الموفق الاعلامي" subtitle="Aperçu du médiateur de Nefzawa"  />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center my-32">
             <p className="text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed italic font-latin" >
               Cette section vous propose un aperçu général du médiateur de Nefzawa à travers ce carousel. Nous vous invitons à le faire défiler afin de découvrir progressivement son contenu.
             </p>
          </div>
