...
const imagesFolder = import.meta.glob(
  "/src/assets/images/nefzawa-images/carousel-images/page-presentation-radio/*.webp",
  { eager: true },
);
...
export default function RadioPresentation() {
  ...
  return (
    <div className="bg-[#fdfdfd] min-h-screen pb-32 font-arabic">
      ...
      <HeaderSection
        title="من نحن"
        subtitle="Découvrez Nefzawa, son identité et ses engagement"
      />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center my-32">
            <p className="text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed italic font-latin">
              Découvrez Nefzawa à travers une présentation générale de son
              identité et de ses principaux projets. Nous vous invitons à
              parcourir les différents slides afin d’en avoir une vision globale
              et de mieux comprendre son évolution.
            </p>
          </div>
