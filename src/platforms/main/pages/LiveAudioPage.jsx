...
const AUDIO_BARS = [
  40, 80, 50, 100, 60, 30, 90, 45, 70, 55, 85, 40, 100, 60, 30, 90, 45, 70, 55,
  85,
];
export default function LiveAudioPage() {
  ...
  return (
    ...
    >
      ...
      <HeaderSection
        title="راديو نفزاوة"
        subtitle="صوت الجنوب التونسي مباشرة من قبلي"
        dark={true}
      />
          ...
          <div className="lg:col-span-8">
            <div className="bg-zinc-900/90 backdrop-blur-2xl border border-white/10 rounded-[3rem] p-8 md:p-16 shadow-2xl relative overflow-hidden">
              <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="relative flex-shrink-0">
                  <div
                    className={`w-56 h-56 md:w-72 md:h-72 rounded-full p-2 border-2 border-dashed transition-all duration-1000 ${isPlaying ? "border-[#E00A0A] animate-[spin_30s_linear_infinite]" : "border-zinc-700"}`}
                  >
                    <div className="w-full h-full rounded-full overflow-hidden relative border-4 border-zinc-800 shadow-2xl">
                      ...
                      <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                        {isPlaying && (
                          <div className="w-16 h-16 bg-[#E00A0A] rounded-full animate-ping opacity-40"></div>
                        )}
                        <Radio
                          size={60}
                          className={isPlaying ? "text-white" : "text-white/20"}
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex-grow text-center md:text-right">
                  <h2 className="text-4xl md:text-6xl font-black mb-4">
                    نفزاوة <span className="text-[#E00A0A]">FM</span>
                  </h2>
                  ...
                  <div className="flex flex-col gap-10">
                    <div className="flex items-center justify-center md:justify-start gap-6">
                      ...
                      <div>
                        <p className="text-zinc-500 text-sm mb-1 uppercase font-latin tracking-widest">
                          ON AIR
                        </p>
                    ...
                    <div className="flex items-center gap-4 bg-white/5 p-5 rounded-2xl border border-white/10 max-w-sm">
                      ...
                      />
                      <span className="text-sm text-zinc-400 font-mono w-12">
                        {volume}%
                      </span>
                    </div>
                  </div>
            ...
            <article className="bg-white/5 border border-white/5 rounded-[3rem] p-8 md:p-12 space-y-6">
              ...
              <div className="text-zinc-300 leading-[2] text-lg space-y-4">
                <p>
                  تتيح لك هذه الواجهة الرقمية إمكانية الاستماع إلى البث الإذاعي
                  المباشر في أي وقت ومن أي مكان في العالم، دون انقطاع، عبر تجربة
                  صوتية سلسة وعالية الجودة.
                </p>

                <p>
                  تم تصميم هذه الصفحة لتوفر وصولًا سريعًا وسهلًا إلى البث
                  المباشر، مما يسمح للمستخدمين بمتابعة البرامج الإذاعية
                  والاستماع إلى المحتوى الصوتي فور بثه بشكل مباشر.
                </p>

                <p>
                  سواء كنت في المنزل، في العمل، أثناء التنقل أو في أي مكان في
                  العالم، تمنحك هذه المنصة إمكانية البقاء على اتصال دائم بالبث
                  الصوتي والاستمتاع بتجربة استماع مرنة ومتاحة على مدار الساعة.
                </p>
              </div>
            </article>
          </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-zinc-900/50 border border-white/10 rounded-[2.5rem] p-8 text-center shadow-xl">
              ...
              <p className="text-zinc-500 text-sm mb-6 leading-relaxed">
                استمع إلينا في أي وقت عبر تطبيقنا على متجر Google Play
              </p>
              <a
            ...
            <div className="bg-[#E00A0A] rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-white/80 text-sm mb-6 relative z-10 leading-relaxed">
                شارك الرابط مع أصدقائك للاستماع إلى نفزاوة أف أم
              </p>
              <button
                onClick={handleShare}
